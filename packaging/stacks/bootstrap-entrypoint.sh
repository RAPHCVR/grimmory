...
INCOMPLETE_PATH="${STACKS_DOWNLOAD_INCOMPLETE_PATH:-/download/incomplete}"
...
if updated != text:
    ...
    print(f"[stacks-bootstrap] Patched {path}: flaresolverr enabled and download paths enforced.")
else:
